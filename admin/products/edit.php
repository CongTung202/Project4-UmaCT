...
<div style="margin: 20px;">
    ...
    <form action="" method="POST" style="max-width: 600px;">
        ...
        <div class="form-group" style="margin-bottom: 15px;">
            ...
            <!-- Bắt buộc phải có id="product_desc" và giữ nguyên value của mô tả cũ -->
            <textarea name="description" id="product_desc" class="form-control" rows="4" style="width: 100%; padding: 8px;"><?= htmlspecialchars($product['description'] ?? '') ?></textarea>
        </div>
